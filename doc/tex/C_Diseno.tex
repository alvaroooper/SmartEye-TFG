...
{ \multicolumn{1}{l}{Atributo} & \multicolumn{1}{l}{Descripción} \\}{
	...
	\texttt{activo} & Indica si la suscripción está vigente. Es obligatorio y tiene valor por defecto \texttt{TRUE}, este dato se ha creado por velocidad en las consultas ya que se podría ver mirando por fecha si está vencido pero supondría mas procesamiento.\\
...
{ \multicolumn{1}{l}{Atributo} & \multicolumn{1}{l}{Descripción} \\}{
	...
	\texttt{activo} & Indica si el acceso está actualmente operativo. Es obligatorio y tiene valor por defecto \texttt{TRUE}, este dato se ha creado por velocidad en las consultas ya que se podría ver mirando por fecha si está vencido pero supondría mas procesamiento.\\
...
{ \multicolumn{1}{l}{Atributo} & \multicolumn{1}{l}{Descripción} \\}{
	...
	\texttt{publico} & Indica si el pipeline puede usarse para todo el mundo (creados por administradores) o sólo para el creador, esto tiene sentido ya que en un futuro si se contempla que los usuarios puedan crear sus propios pipelines de forma que gracias a este campo se agilice la consulta a la bd viendo cuales son los públicos a mostrar en lugar de tener que consultar si el usuario que lo creó era o no administrador. \texttt{TRUE}.\\
...
{ \multicolumn{1}{l}{Atributo} & \multicolumn{1}{l}{Descripción} \\}{
	...
	\texttt{config\_aplicada} & Configuración real utilizada en la ejecución ya sea con los valores predeterminados o con los modificados por el usuario. Se permite \texttt{NULL} porque no siempre será necesario persistirla.\\
}
