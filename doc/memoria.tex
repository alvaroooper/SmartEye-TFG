...
% Datos de portada
\title{Diseño e implementación de una plataforma web para el procesamiento de imágenes mediante pipelines de inteligencia artificial}
\author{\nombre}
...
\noindent Que el alumno D. \nombre, con DNI 71956263G, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado ``Diseño e implementación de una plataforma web para el procesamiento de imágenes mediante pipelines de inteligencia artificial''.
...
\begin{abstract}
	This Final Degree Project presents the design and implementation of a web application for image processing using artificial intelligence models. The system allows authenticated users to select analysis workflows, upload images, execute computer vision models and obtain both a processed image or iamges and structured information in JSON format.
...
\begin{description}
	...
	\item[CSS] \textit{Cascading Style Sheets}. Lenguaje de estilos utilizado para definir la presentación visual de páginas \textit{web}.
	\item[HTML] \textit{HyperText Markup Language}. Lenguaje de marcado utilizado para definir la estructura de páginas \textit{web}.
	\item[JSON] \textit{JavaScript Object Notation}. Formato ligero de intercambio de datos basado en texto.
	\item[JWT] \textit{JSON Web Token}. Mecanismo basado en \textit{tokens} firmados para representar información de identidad o sesión.
	\item[HTTP] \textit{HyperText Transfer Protocol}. Protocolo de comunicación utilizado en la \textit{web}.
	\item[ORM] \textit{Object-Relational Mapping}. Técnica de mapeo objeto-relacional.
\end{description}
