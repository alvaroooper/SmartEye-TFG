...
% Datos de portada
\title{\HUGE SmartEye\\[0.5cm]\Large Analizador de imágenes con flujos encadenados de inteligencia artificial}
\author{\nombre}
...
\noindent Que el alumno D. \nombre, con DNI 71956263G, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado ``SmartEye- Analizador de imágenes con flujos encadenados de inteligencia artificial''.
...
La solución final se plantea como una plataforma web que unifica en un mismo entorno la ejecución de análisis visuales sobre imágenes, la configuración de flujos de procesamiento y la consulta de los resultados generados. De este modo, el sistema no se limita a ejecutar modelos de forma aislada, sino que ofrece una aplicación organizada para utilizar capacidades de visión por computador de manera controlada, accesible y preparada para futuras ampliaciones.
...
\begin{abstract}
	Visión por computador, inteligencia artificial, procesamiento de imágenes, aplicación web.
\end{abstract}
...
\begin{abstract}
	...
	The final solution is conceived as a web platform that brings together, within a single environment, the execution of visual analyses on images, the configuration of processing workflows and the consultation of the generated results. In this way, the system is not limited to running models in isolation, but provides an organised application for using computer vision capabilities in a controlled, accessible way, while remaining prepared for future extensions.
...
\begin{abstract}
	Computer vision, artificial intelligence, image processing, web application.
\end{abstract}
